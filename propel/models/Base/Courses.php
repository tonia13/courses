...
abstract class Courses implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\CoursesTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\Courses object.
     */
     ...
     * @return $this|\Propel\Courses The current object (for fluent API support)
     */
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[CoursesTableMap::COL_TITLE] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CoursesTableMap::COL_STATUS] = true;
        }
    ...
    /**
     * Sets the value of the [is_premium] column.
    ...
    public function setIsPremium($v)
    {
        ...
        if ($this->is_premium !== $v) {
            $this->is_premium = $v;
            $this->modifiedColumns[CoursesTableMap::COL_IS_PREMIUM] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CoursesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            if ($this->deleted_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->deleted_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CoursesTableMap::COL_DELETED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CoursesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CoursesTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CoursesTableMap::translateFieldName('IsPremium', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_premium = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CoursesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CoursesTableMap::translateFieldName('DeletedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = CoursesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Courses'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CoursesTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(CoursesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CoursesTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CoursesTableMap::COL_IS_PREMIUM)) {
            $modifiedColumns[':p' . $index++]  = 'is_premium';
        }
        if ($this->isColumnModified(CoursesTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CoursesTableMap::COL_DELETED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'status':
                        ...
                        break;
                    case 'is_premium':
                        $stmt->bindValue($identifier, (int) $this->is_premium, PDO::PARAM_INT);
                        break;
                    case 'created_at':
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Courses The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CoursesTableMap::COL_TITLE)) {
            $criteria->add(CoursesTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(CoursesTableMap::COL_DESCRIPTION)) {
            $criteria->add(CoursesTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CoursesTableMap::COL_STATUS)) {
            $criteria->add(CoursesTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CoursesTableMap::COL_IS_PREMIUM)) {
            $criteria->add(CoursesTableMap::COL_IS_PREMIUM, $this->is_premium);
        }
        if ($this->isColumnModified(CoursesTableMap::COL_CREATED_AT)) {
            $criteria->add(CoursesTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CoursesTableMap::COL_DELETED_AT)) {
            $criteria->add(CoursesTableMap::COL_DELETED_AT, $this->deleted_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Courses (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsPremium($this->getIsPremium());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Courses Clone of current object.
     * @throws PropelException
     */
